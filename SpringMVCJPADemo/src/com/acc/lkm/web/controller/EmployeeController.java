...
public class EmployeeController {
	...
	//After execution of this method empObj will be stored in session scope 
		...
		public ModelAndView getAllEmployee() throws Exception {
		    List<EmployeeEntity> empDetails = employeeService.getAllEmployees();
		    ModelAndView mav = new ModelAndView();
		    mav.setViewName("DisplayDetails");
		    mav.addObject("empObj2", empDetails);  // Ensure this matches the JSP
		    return mav;
		}
...
//	    public ModelAndView getAllEmployee() throws Exception {
//	        List<EmployeeEntity> empDetails = employeeService.getAllEmployees();
////			List<EmployeeBean> empDetails = employeeService.getAllEmployees();
//	        ModelAndView mav = new ModelAndView();
//	        System.out.println("Details");
//	        System.out.println(empDetails.getClass());
//	        mav.setViewName("DisplayDetails");
//	        mav.addObject("empObj",empDetails);
//	        return mav;
//	    }
		...
		public ModelAndView handleAllExceptions(Exception exception) {
			ModelAndView modelAndView=new ModelAndView();;
			modelAndView.setViewName("GeneralizedExceptionHandler");
			modelAndView.addObject("message",exception.getMessage());
			modelAndView.addObject("exception",exception);
			return modelAndView;
		}
